...
public class BookBeanTableData {
    ...
    private SimpleStringProperty bookNum;

    public BookBeanTableData() {}

    public BookBeanTableData(String bookId, String bookName, String bookAuthor, String bookAuthorSex, String bookPrice, String bookDescription, String bookType,String bookNum) {
    ...
    public String getBookNum(){return bookNum.get();}

    public SimpleStringProperty bookNumProperty(){ return bookNum; }

    public void setBookNum(String bookNum){this.bookNum.set(bookNum);}
}
