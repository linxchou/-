...
public class BookBean implements Serializable {
    ...
    public BookBean(int bookId, String bookName, String bookAuthor, String bookAuthorSex, float bookPrice, String bookDescription, String bookTypeId,int bookNum) {
        this.bookId = bookId;
